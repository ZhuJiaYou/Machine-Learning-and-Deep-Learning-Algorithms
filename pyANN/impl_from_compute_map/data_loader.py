...
def dataset_loader(data_dir):
    ...
    test_label = read_label(os.path.join(data_dir, "t10k-labels.idx1-ubyte"))
...
if __name__ == '__main__':
    data_dir = "/home/zjy/nlp/Machine_Learning_and_Deep_Learning_Algorithms/datasets"
    x_train, t_train, x_test, t_test = dataset_loader(data_dir)
    print(x_train.shape)
    print(t_train.shape)
