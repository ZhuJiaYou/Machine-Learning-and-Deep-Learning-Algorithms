...
class Network(object):
    ...
    def SGD(self, training_data, epoches, mini_batch_size, eta, test_data=None):
        ...
        If "test_data" is provided, the network will be evaluated with them after each opoch, and partial 
            progress will be printed out.
            This is usful for tracking progress, but slows things down substantially.
        '''
        if test_data:
